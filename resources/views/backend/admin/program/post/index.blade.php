...
@section('content')
						...
						<div class="page-header">
							...
							<div class="ms-auto pageheader-btn">
								<a href="{{route('admin.programs.create')}}" class="btn btn-primary btn-icon text-white me-2">
									<span>
										<i class="fe fe-plus"></i>
									</span> Create New Program
								</a>
                                ...
                                @foreach($programs as $program)
									<tr>
										...
										<td>
                                            ...
                                            onclick="deletepost$post({{ $program->id}})" >
                                            <i class="fa fa-trash"></i>
                                            </button>
                                            <form id="deleteform-{{$program->id}}" action="{{route('admin.programs.destroy',$program->id)}}" method="POST" style="display: none;">
                                            @csrf
                                            @method('DELETE')
                                            </form>
                                            </td>
