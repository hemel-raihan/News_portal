									...
									<div class="col-lg-6 col-md-12 col-sm-12 col-xl-3">
										<div class="card overflow-hidden">
											<div class="card-body">
												<div class="row">
													<div class="col">
														<h6 class="">Total Program</h6>
														@php
															$programs = \App\Models\Program\Program::all();
															$program_post_count = count($programs);
														@endphp
														<h3 class="mb-2 number-font">{{ $program_post_count }}</h3>
														{{-- <p class="text-muted mb-0">
									...
									<div class="col-lg-6 col-md-12 col-sm-12 col-xl-3">
										<div class="card overflow-hidden">
											<div class="card-body">
												<div class="row">
													<div class="col">
														<h6 class="">Total Advertisement</h6>
                                                        @php
															$advertisement = \App\Models\Advertisement\Advertisement::all();
															$advertisement_post_count = count($advertisement);
														@endphp
														<h3 class="mb-2 number-font">{{$advertisement_post_count}}</h3>
														{{-- <p class="text-muted mb-0">
